      ...
      <div class="header flex">
          <div class="left flex">
            ...
            <div class="right flex">
                <button @click="toggleEditInvoice(currentInvoice.docId)" class="purple">Edit</button>
                <button @click="deleteInvoice(currentInvoice.docId)" class="red">Delete</button>
                <button v-if="currentInvoice.invoicePending" @click="updateStatusPaid(currentInvoice.docId)" class="green">Mark as Paid</button>
                <button 
                 v-if="currentInovice.invoiceDraft || currentInvoice.invoicePaid"
      ...
      <div class="invoice-details flex flex-column">
          <div class="top flex">
              <div class="left flex flex-column">
                  <span class="tracking-number">#{{ currentInvoice.invoiceId }}</span>
...
export default {
    ...
    methods: {
        ...
        ...mapActions(['DELETE_INVOICE', 'UPDATE_SATATUS_TO_PAID', 'UPDATE_SATATUS_TO_PENDING']),
        ...
        updateStatusToPaid (docId) {
            this.UPDATE_SATATUS_TO_PAID(docId)
        },

        updateStatusToPending (docId) {
            this.UPDATE_SATATUS_TO_PENDING(docId)
        }
    },
    computed: {
